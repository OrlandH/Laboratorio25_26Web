        ...
        //Crear una funcion autejecutada para consultar el metro en base al ID
        {
            (async function (idMetro) {
                ...
                try {
                    ...
                    const respuesta = await (await fetch(`https://65b81bf146324d531d55f660.mockapi.io//metro/${idMetro}`)).json()
    ...
    //Validacion
        ...
        try {
            if(form.id){
                ...
                //Establecer la url
                const url = `https://65b81bf146324d531d55f660.mockapi.io//metro/${form.id}`
                //Uso del fetch
                await fetch(url,{
                    method:'PUT',
            ...
            const url ="https://65b81bf146324d531d55f660.mockapi.io//metro"
						form.id = uuidv4()
            await fetch(url,{
